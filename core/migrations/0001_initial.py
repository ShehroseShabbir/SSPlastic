# Generated by Django 5.2.5 on 2025-09-20 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, default='', help_text='Please put any notes you want to include in bills in footer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_opening_adjustment', models.BooleanField(default=False, help_text='Tick for one-time opening/correction. Allows negative kg and syncs to ledger as adjustment.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate_pkr', models.DecimalField(decimal_places=2, default=Decimal('0.00'), help_text='Rate per kg (PKR, can include decimals).', max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
