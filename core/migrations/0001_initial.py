    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_pending_balance_pkr', models.IntegerField(default=0, help_text='Carry-forward A/R from previous month in whole rupees (PKR).')),
            ],
        ),
        migrations.CreateModel(
            name='Employee',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='raw_material_links', to='core.payment')),
