...
COUNTRIES = [("Pakistan", "Pakistan"), ("Australia", "Australia") , ("Germany", "Germany"), ("United States of America", "United States of America"), ("United States of America", "United States of America")]

BANK_NAMES = [
    # Big 5 + Major Commercial Banks
    ("HBL", "HBL"),
    ("MCB Bank", "MCB Bank"),
    ("UBL", "UBL"),
    ...
    # Digital / Fintech & Mobile Wallets
    ("EasyPaisa", "EasyPaisa"),
    ("JazzCash", "JazzCash"),
    ("NayaPay", "NayaPay"),
    ("SadaPay", "SadaPay"),
    ...
    ("U Microfinance Bank", "U Microfinance Bank"),
